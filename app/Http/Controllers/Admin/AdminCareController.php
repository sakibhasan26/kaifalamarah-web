...
class AdminCareController extends Controller
{
    ...
    public function sendEmail(Request $request) {
        ...
        try{
            ...
            return back()->with(['error' => [__("Opps! Faild to send mail. Please recheck your mail credentials or reconfigure mail")]]);
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile("image")) {
            try {
                ...
                return back()->with(['error' => [__('Opps! Faild to upload image')]]);
            }
        }
    ...
    public function update(Request $request)
    {
        ...
        if (!$admin) {
            return back()->with(['warning' => [__('Opps! Target admin not found!')]]);
        }
    ...
    public function roleUpdate(Request $request)
    {
        ...
        if (!isset($request->target)) {
            return back()->with(['error' => [__('Opps! Target not found!')]]);
        }

        $role = AdminRole::find($request->target);
        if (!$role) {
            return back()->with(['error' => __("Opps! Target role not found!")]);
        }
