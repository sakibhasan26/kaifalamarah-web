...
class PaymentGateway {
    ...
    public function gateway() {
        $request_data = (array)$this->request_data;
        ...
        // if ($request_data['payment_type'] == "ADD-MONEY") {
        //     $user_wallet = $this->getUserWallet($defualt_currency);
        //     if (!$user_wallet) {
        //         throw ValidationException::withMessages([
        //             $this->currency_input_name = "User wallet not found!",
    ...
    public function responseReceive($type = null) {
        ...
        $validator_data = [
            ...
            'user_type'                => $tempData['data']->user_type ?? null,
    ...
    public function handleCallback($reference,$callback_data,$gateway_name) {
        ...
        if($transaction) {
            ...
            logger('validated_data',[  $validator_data]);

            if ($tempData->data->user_type == 'authenticated') {
            ...
            $this->output['request_data']['user_type'] =$tempData['data']->user_type;
        }else {
