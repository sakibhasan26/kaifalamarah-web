        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="account-wrapper kyc">
                    ...
                    <form action="{{ route('api.v1.user.add-money.api.razor.callback') }}" method="GET">
                        <script
                        ...
                        <input type="hidden" value="{{ route('api.v1.user.add-money.razor.api.razor.cancel',$orderId) }}" name="razorpay_cancel_url">
