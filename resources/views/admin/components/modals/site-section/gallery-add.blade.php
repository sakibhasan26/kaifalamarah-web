<div id="gallery-add" class="mfp-hide large">
    <div class="modal-data">
        <div class="modal-header px-0">
            <h5 class="modal-title">{{ __("Add Gallery Image") }}</h5>
        </div>
                               ...
                               <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        <div class="col-xl-12 col-lg-12 form-group">
                                            ...
                                            <select name="{{ $default_lang_code . "_tag" }}" id="" class="select2-auto-tokenize"></select>
                                        </div>
                                    </div>
                               </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 form-group">
                                            <div class="col-xl-12 col-lg-12 form-group">
                                                ...
                                                <select name="{{ $lang_code . "_tag" }}" id="" class="select2-auto-tokenize"></select>
                                            </div>
                                        </div>
                                    </div>
                                </div>
