...
<div class="custom-card">
    ...
    <div class="card-body">
        <form class="card-form" action="{{ setRoute("admin.setup.sections.overview-left-section.update") }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <input type="hidden" name="target" value="{{ $section_language['id'] }}">
                            ...
                            <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif" id="english" role="tabpanel" aria-labelledby="english-tab">
                                ...
                                <div class="form-group">
                                    @include('admin.components.form.input',[
                                        ...
                                        'value'     => old($default_lang_code . "_heading",$section_language['language'][$default_lang_code]['heading'] ?? "")
                                    ])
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <textarea name="{{ $default_lang_code . "_details" }}" class="form--control rich-text-editor"> 
                                            {!! old($default_lang_code . "_details", $section_language['language'][$default_lang_code]['details'] ?? "") !!}
                                        </textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif" id="{{ $item->name }}" role="tabpanel" aria-labelledby="english-tab">
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                            ...
                                            'value'     => old($lang_code . "_heading",$section_language['language'][$lang_code]['heading'] ?? ""),
                                        ])
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <textarea name="{{ $lang_code . "_details" }}" class="form--control rich-text-editor"> 
                                                {!! old($lang_code . "_details", $section_language['language'][$lang_code]['details'] ?? "") !!}
                                            </textarea>
                                        </div>
                                    </div>
