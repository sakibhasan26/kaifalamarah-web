                ...
                <div class="row justify-content-center mb-10-none">
                    <div class="col-xl-4 col-lg-4 form-group">
                        @include('admin.components.form.input-file',[
                            'label'             => __("Register Image"),
                            'name'              => "register_image",
                            'class'             => "file-holder",
                            'old_files_path'    => files_asset_path("site-section"),
                            'old_files'         => $data->value->images->register_image ?? "",
                        ])
                    </div>
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="product-tab">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif" id="english" role="tabpanel" aria-labelledby="english-tab">
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                            'label'     => __("Agree Policy Title"),
                                            'name'      => $default_lang_code . "_agree_policy_title",
                                            'value'     => old($default_lang_code . "_agree_policy_title",$data->value->language->$default_lang_code->agree_policy_title ?? "")
                                        ])
                                    </div>
                                ...
                                @foreach ($languages as $item)
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif" id="{{ $item->name }}" role="tabpanel" aria-labelledby="english-tab">
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                'label'     => __("Agree Policy Title")."*",
                                                'name'      => $lang_code . "_agree_policy_title",
                                                'value'     => old($lang_code . "_agree_policy_title",$data->value->language->$lang_code->agree_policy_title ?? "")
                                            ])
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        <div class="form-group">
                            <label for="">{{ __("Agree Policy Link") }}*</label>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">{{ url('/') }}/</span>
                                <input type="text" class="form--control" placeholder="Agree Policy Link" name="agree_policy_link" value="{{  old("agree_policy_link",$data->value->agree_policy_link ?? "") }}">
                            </div>
                        </div>
                    </div>
