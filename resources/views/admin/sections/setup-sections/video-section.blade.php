                                ...
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif" id="english" role="tabpanel" aria-labelledby="english-tab">
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                            'label'     => __("View Info")."*",
                                            'name'      => $default_lang_code . "_view_info",
                                            'value'     => old($default_lang_code . "_view_info",$data->value->language->$default_lang_code->view_info ?? "")
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input',[
                                            'label'     => __("Video Link")."*",
                                            'name'      => $default_lang_code . "_video_link",
                                            'value'     => old($default_lang_code . "_video_link",$data->value->language->$default_lang_code->video_link ?? "")
                                        ])
                                    </div>
                                ...
                                @foreach ($languages as $item)
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif" id="{{ $item->name }}" role="tabpanel" aria-labelledby="english-tab">
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                'label'     => __("View Info")."*",
                                                'name'      => $lang_code . "_view_info",
                                                'value'     => old($lang_code . "_view_info",$data->value->language->$lang_code->view_info ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
