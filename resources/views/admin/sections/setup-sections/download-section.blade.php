                ...
                <div class="row justify-content-center mb-10-none">
                    ...
                    {{-- <div class="col-xl-4 col-lg-4 form-group">
                        @include('admin.components.form.input-file',[
                            ...
                            'old_files'         => $data->value->images->home_image ?? "",
                        ])
                    </div> --}}

                    <div class="col-xl-3 col-lg-3 form-group">
                        @include('admin.components.form.input-file',[
                            'label'             => __("Play Store QR Image"),
                            'name'              => "play_store_qr_image",
                            'class'             => "file-holder",
                            'old_files_path'    => files_asset_path("site-section"),
                            'old_files'         => $data->value->images->play_store_qr_image ?? "",
                        ])
                    </div>

                    <div class="col-xl-3 col-lg-3 form-group">
                        @include('admin.components.form.input-file',[
                            'label'             => __("App Store QR Image"),
                            'name'              => "app_store_qr_image",
                            'class'             => "file-holder",
                            'old_files_path'    => files_asset_path("site-section"),
                            'old_files'         => $data->value->images->app_store_qr_image ?? "",
                        ])
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 form-group">
                        @include('admin.components.form.input-file',[
                            ...
                            'class'             => "file-holder",
                            'old_files_path'    => files_asset_path("site-section"),
                            'old_files'         => $data->value->images->app_store ?? "",
                        ])
                    </div>
