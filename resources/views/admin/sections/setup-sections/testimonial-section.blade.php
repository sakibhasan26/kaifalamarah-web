                ...
                <div class="row justify-content-center mb-10-none">
                    {{-- <div class="col-xl-3 col-lg-3 form-group">
                        @include('admin.components.form.input-file',[
                            'label'             => __("Image One"),
                            'name'              => "small_image_one",
                            'class'             => "file-holder",
                            'old_files_path'    => files_asset_path("site-section"),
                            'old_files'         => $data->value->images->small_image_one ?? "",
                        ])
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 form-group">
                        @include('admin.components.form.input-file',[
                            'label'             => __("Image Two"),
                            'name'              => "small_image_two",
                            'class'             => "file-holder",
                            'old_files_path'    => files_asset_path("site-section"),
                            'old_files'         => $data->value->images->small_image_two ?? "",
                        ])
                    </div>
                    <div class="col-xl-3 col-lg-3 form-group">
                        @include('admin.components.form.input-file',[
                            'label'             => __("Image Three"),
                            'name'              => "small_image_three",
                            'class'             => "file-holder",
                            'old_files_path'    => files_asset_path("site-section"),
                            'old_files'         => $data->value->images->small_image_three ?? "",
                        ])
                    </div> --}}
                    {{-- <div class="col-xl-3 col-lg-3 form-group">
                        @include('admin.components.form.input-file',[
                            'label'             => __("Image Four"),
                            'name'              => "small_image_four",
                            'class'             => "file-holder",
                            'old_files_path'    => files_asset_path("site-section"),
                            'old_files'         => $data->value->images->small_image_four ?? "",
                        ])
                    </div> --}}
                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td><a href="{{ $item->language->$system_default_lang->name ?? "" }}" class="text--danger">{{ $item->language->$system_default_lang->name ?? "" }}</a></td>
                                {{-- <td><a href="{{ $item->language->$system_default_lang->link ?? "" }}" class="text--danger">{{ $item->language->$system_default_lang->link ?? "" }}</a></td> --}}
                                <td>
