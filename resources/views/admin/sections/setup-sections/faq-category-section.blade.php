...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#faq-category-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Category") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.faq-category-add')
...
@push('script')
    ...
    <script>
        openModalWhenError("faq-category-add","#faq-category-add");
