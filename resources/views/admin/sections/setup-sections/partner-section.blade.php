...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#partner-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Solution") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.partner-add')
...
@push('script')
    ...
    <script>
        openModalWhenError("partner-add","#partner-add");
