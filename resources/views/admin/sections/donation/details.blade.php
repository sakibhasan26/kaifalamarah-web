...
@section('content')
    <div class="custom-card">
        <div class="card-header">
            <h6 class="title">{{ __("Donation Details") }}</h6>
        </div>
        <div class="card-body">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="modal-form" action="{{ setRoute('admin.donation.approved') }}" method="POST">
        ...
        <div class="modal fade" id="rejectModal" tabindex="-1" >
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="modal-form" action="{{ setRoute('admin.donation.rejected') }}" method="POST">
                            @csrf
                            @method("PUT")
                            <div class="row mb-10-none">
                                <div class="col-xl-12 col-lg-12 form-group">
