                ...
                <div class="row mb-10-none">
                    ...
                    <div class="col-md-12">
                        @if ($gateway->isRazorpay($gateway))
                            <div class="">
                                <p class="fw-bold">{{ __("Callback URL") }}</p>
                                {{ setRoute('user.razorpay.payment.callback',[$gateway->alias, 'token' => payment_gateway_const()::CALLBACK_HANDLE_INTERNAL]) }}
                            </div>
                        @endif


                        {{-- IF gateway is payStack need to show the callback URL --}}
